...
export default function Modetwo() {
  ...
  const reset = () => {
    ...
    setRolledValue(0);
    setTarget(10+Math.ceil(Math.random() * 55));
    setrB(12);
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View>
        ...
        >
          Target of {target} in 2 Over
        </Text>
      </View>
      <Text style={{color:"gray",textAlign:"center",marginBottom:10}}> You have {ball} balls remaining </Text>
     
      <Text style={{ fontWeight: "bold",marginTop:20 }}>ROBOT :</Text>
      <View
        style={{
      ...
      >
        ...
        <View>
          {IsPlaying ? (
            ...
            >
              {wmsg ? <>Congratulations !!! You have Won the game with {ball} balls left</> : null}
              {lmsg ? (
                <>
      ...
      >
        {showreset ? (
          ...
          <>
            ...
            >
              You need {target - score} runs to win
            </Text>
          </>
        )}
      </View>
